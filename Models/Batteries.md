# EZ-Flash Battery Reference

Use this table to see which models use a battery, what it powers, and whether the battery can be replaced easily.

| **Model**           | **Battery** | **Type**         | **Function**         | **Replaceable**        |
|---------------------|-------------|------------------|----------------------|------------------------|
